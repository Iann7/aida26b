...
# TO DO LIST 
## Server 
- Agregar otro schema para el resto de los mensaje 
## UI/UX
- Actualizar los barcos automaticamente cada x segundos/minutos 
...
- Filtros
	...
	- por MMSI 
    ### Fixes UI
    - arreglar que cuando se clickea en un barco en la tabla suba al mapa a mostrarte mientras se mueve en el mapa **(Listo)**
    - Cuando clickeas en un barco en la tabla (no en el boton de agregar) se agregue tambien en el mapa, no solo te lleve a donde está **(Listo)**
